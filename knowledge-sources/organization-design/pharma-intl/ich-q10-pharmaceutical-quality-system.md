---
docId: 'ich-q10-pharmaceutical-quality-system'
title: 'Pharmaceutical Quality System Q10 (ICH Harmonised Tripartite Guideline)'
sourceType: 'international_standard'
author_or_issuer: 'International Conference on Harmonisation of Technical Requirements for Registration of Pharmaceuticals for Human Use (ICH)'
edition_or_version: 'Current Step 4 version dated 4 June 2008'
publication_date: '2008-06-04'
source_url: 'https://database.ich.org/sites/default/files/Q10%20Guideline.pdf'
license_or_terms: 'ICH legal notice (standard notice carried by ICH guidelines on database.ich.org): "This document is protected by copyright and may, with the exception of the ICH logo, be used, reproduced, incorporated into other works, adapted, modified, translated or distributed under a public license provided that ICH''s copyright in the document is acknowledged at all times." Adaptations must be clearly labelled; ICH endorsement must not be implied. (Q10 file itself is a 2020-regenerated PDF without the notice page; wording verified from official ICH Q9(R1) guideline PDF, same database.)'
language: 'en'
...
ICH Q10 describes one comprehensive model for an effective pharmace utical quality 
...
Development). The quality system elements and management respo nsibilities 
...
quality risk management, and the effectiveness of the pharmaceutical quality syst em. 
...
professionals, regulatory authorities (including compliance with approved regula tory 
...
and product quality, thereby providing assurance of continued s uitability and 
...
achievement of the objecti ves described in Section 1.5 above by providing the means 
...
commercial life of the prod uct up to and including product discontinuation. For 
...
to acquiring, analysing, storing and dis seminating information related to products, 
...
development studies; technology transfer activ ities; process validation studies over 
...
performance and product quality throughout the product lifecycle. IC H Q9 provides 
...
(a) The design, organisation and documentation of the pharmaceutical quali ty 
...
and proportionate to each of the product lifecycle stages, recognising t he 
...
4 
modifying an existing one. The design of the pharmaceu tical quality system 
...
(e) Management r esponsibilities, as described in Section 2, should be identified 
within the pharmaceutical quality system.  
(f) The pharmaceutical quality system should include the following elements, as 
described in Section 3: process performance and product quality monitori ng, 
...
be useful tools to facilitate depicting pharmaceutical quality system processe s 
in a visual manner;  
...
that roles, responsibilities, and autho rities are defined, communicated and 
...
(2) Demonstrate strong and visible support for th e pharmaceutical quality
...
(4) Define individual and co llective roles, responsibilities, authorities and 
...
independent qual ity unit/structure with authority to fulfil certain 
...
(b) The quality policy should include an expe ctation to comply with applicable 
...
effectiveness.  
(b) Management should ensure that resources are appropri ately applied to a
...
(b) Communications processes should ensure the flow of ap propriate information 
...
(a) Senior management should be r esponsible for pharmaceutical quality system 
...
performance and product quality and of the pha rmaceutical quality system, as 
...
activities and quality of purchased materials. These proces ses should incorporate 
...
provide the material using a defined suppl y chain (e.g. , audits, material 
...
included in a written agreement betwee n the contract giver and contract 
acceptor;  
...
(d) Monitoring incoming ingre dients and materials to ensure they are from 
...
needs of patients and h ealthcare professionals, and regulatory authorities and 
...
The goals of manufacturing activities include achieving produc t realisation, 
...
effective monitoring system provides assurance of the continu ed capability of 
...
system should:  
(a) Use quality risk management to establish the control str ategy. This can 
...
(d) Identify sources of variation affecting process performance and produ ct quality 
...
rejections, non -conformances, recalls, deviations, audits, regulato ry inspections and 
...
determining the root cause. The level of effort, formality, and documen tation of the 
...
Table II: Application of Corrective Action a nd Preventive Action System 
...
management system. There is generally a difference in fo rmality of change 
...
requirements.  
The change management system ensures continual improvement is und ertaken in a 
...
ICH Q8, working within the design spa ce is not considered a change (from a 
...
management system;  
(c) Proposed changes should be evaluated by expert teams c ontributing the 
...
company, management r eview can be a series of reviews at various levels of 
...
Table IV:  Application o f Management Review of Process Performance and 
...
customer audits.  
4.2 Monitoring of In ternal and External Factors Impacting the 
Pharmaceutical Quality System  
...
parameters and attributes related to drug substance and drug product material s and 
...
control. (ICH Q10) 
Corrective Action:  
Action to eliminate the cause of a detect ed non -conformity or other undesirable 
...
Design Space:  
The multidimensional combination and interaction of input var iables (e.g., material 
...
Systematic approach to acquiring, analysing, stor ing, and disseminating information 
...
potential situation. NOTE: Preventive action is taken to preve nt occurrence whereas 
...
patients, health care professionals, and regulatory authorit ies (including compliance 
...
requirements. (ICH Q9)  
Quality Manual:  
Document spec ifying the quality management system of an organisation. (ISO 
9000:2005)  
Quality Objectives:  
A means to translate the quality policy and strategies into measurable activities. (ICH 
Q10)  
Quality Planning:  
Part of quality management focused on setting qu ality objectives and specifying 
...
State of Control:  
A condition in which the set of controls co nsistently provides assurance of continued 
...
pharmaceutical d evelopment, technology transfer, commercial manufacturing, and 
...
bar lists the PQS elements which serv e as the major pillars under the PQS model. 
...
The bottom set of horizontal bars illustrates the e nablers: knowledge management 
