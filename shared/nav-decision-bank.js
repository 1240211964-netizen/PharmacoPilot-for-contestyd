...
(function attachDecisionBank(global) {
  const decisionBank = {
    ...
    3: [
      ["ethics", "学生关心案例伦理边界，教师设计偏管理判断", "建议在真实性学习情境与资源设计环节 把伦理边界加入案例材料。", 3.8],
      ["policy", "学生希望讨论政策合理性，教师定位是服务运营", "建议在预期学习结果与评价证据设计环节 调整目标涵盖政策维度。", 3.7],
    ...
    7: [
      ...
      ["free", "扩大自由讨论，弱化评价标准约束", "讨论会热闹，但证据质量难保证。", 2.0],
    ],
    8: [
    ...
    10: [
      ["rubric", "按评价标准逐项对照学生证据评分", "能保证评分解释性和反馈效度。", 3.8],
  ...
  const questionChainBank = {
    ...
    // ============================================================
    // S4 · 真实性学习情境与资源设计(stationId 6) · 迁移轴:医疗体系/地域
    // ============================================================
    6: {
    ...
    // ============================================================
    // S6 · 形成性评价与适应性调控(stationId 9) · 迁移轴:换触发类型
    // ============================================================
    9: {
      transferAxis: "换触发类型",
      chain: [
    ...
    // ============================================================
    // S7 · 表现性评价与学习成效诊断(stationId 10) · 迁移轴:换学生分布
    // ============================================================
    10: {
      transferAxis: "换学生分布",
      chain: [
    ...
    // ============================================================
    // S8 反思性实践与教学改进 / S9 教学知识建构与专业共享(stationId 11) · 迁移轴:换下轮约束
    // ============================================================
    11: {
      transferAxis: "换下轮约束",
      chain: [
