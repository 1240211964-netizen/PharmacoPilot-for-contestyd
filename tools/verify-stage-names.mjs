...
assert.match(read("nav-detail.html"), /nav-detail\.bundle\.js\?v=21-swot-guide-dedupe/, "navigation bundle cache key must expose the deduplicated SWOT node-guide revision");
